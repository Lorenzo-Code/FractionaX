...
class TopicInfo {
  ...
  static fromBytes(bytes) {
    return TopicInfo._fromProtobuf(HashgraphProto.proto.ConsensusGetTopicInfoResponse.decode(bytes));
  }
   ...
   */
  toBytes() {
    return HashgraphProto.proto.ConsensusGetTopicInfoResponse.encode(/** @type {HashgraphProto.proto.ConsensusGetTopicInfoResponse} */
