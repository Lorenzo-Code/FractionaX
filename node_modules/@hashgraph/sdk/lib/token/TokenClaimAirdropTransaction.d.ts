...
export default class TokenClaimAirdropTransaction extends AirdropPendingTransaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenClaimAirdropTransaction;
    /**
     * @override
     * @internal
     * @returns {HashgraphProto.proto.ITokenClaimAirdropTransactionBody}
     */
    override _makeTransactionData(): HashgraphProto.proto.ITokenClaimAirdropTransactionBody;
}
