...
export default class TokenRejectTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenRejectTransaction;
    /**
     *
     * @param {object} [props]
     ...
     */
    _makeTransactionData(): HashgraphProto.proto.ITokenRejectTransactionBody;
}
